  ...
  return (
    <div className='about_sec'>
        ...
        <div className='text_sec'>
            ...
            {/* Una empresa en compromiso con la innovación */}
            <h3>¿Quienes Somos?</h3>
            {/* Vamos a lo simple. Somos un equipo de personas destinadas a acompañar el desarrollo tecnológico de tu empresa, y hacer las tareas de informática mas simples. */}
