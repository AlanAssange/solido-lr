  ...
  return (
    <div className='about_sec'>
        ...
        <div className='text_sec'>
            ...
            <h2 className='subt_sec'>Una empresa en <b>Compromiso</b> con la <b>Innovación</b></h2>
            <h3>¿Quienes Somos?</h3>
            ...
            <p>Queremos consolidar para el año 2025 una posición firme en el Norte y Centro de la Provincia de Buenos Aires en lo que respecta a soportes de infraestructura IT, ampliando significativamente los servicios que ofrecemos.</p>
        </div>
        </div>
    </div>
  )
